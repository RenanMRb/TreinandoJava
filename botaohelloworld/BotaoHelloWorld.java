package botaohelloworld;

public class BotaoHelloWorld extends javax.swing.JFrame{

    public BotaoHelloWorld() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnClick.setForeground(new java.awt.Color(75,0,130));
    ...
    public static void main(String args []) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BotaoHelloWorld().setVisible(true);
            }
        });
    }
